...
namespace Iota.Lib.CSharpTests
{
    ...
    public class KerlTest
    {
        ...
        //{
        //    int[] tritValue = Converter.ToTrits("KFNNRVYTYYYNHJLBTXOEFYBZTHGXHTX9XKXB9KUZDHGLKBQGPQCNHPGDSGYKWGHVXVLHPOEAWREBIVK99");
        ...
        //    hashValue = kerl.Squeeze(hashValue, 0 , hashValue.Length);

        //    var hash = Converter.ConvertTritsToTrytes(hashValue);
        ...
        //            var trytesOut = Converter.ConvertTritsToTrytes(kerl.Squeeze());

        //            Assert.AreEqual(hashes1, trytesOut);

        //            trytesOut = Converter.ConvertTritsToTrytes(kerl.Squeeze());
